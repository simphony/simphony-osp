...
from simphony_osp.core.ontology.utils import compatible_classes
from simphony_osp.core.utils.cuba_namespace import cuba_namespace
from simphony_osp.core.utils.datatypes import UID
from simphony_osp.core.utils.sparql import SparqlResult

logger = logging.getLogger(__name__)

if TYPE_CHECKING:
    from simphony_osp.core.interfaces.interface import Interface
...
class Session(Environment):
    ...
    def compute(self, *args, **kwargs) -> None:
        ...
        from simphony_osp.core.interfaces.remote.client import \
            RemoteStoreClient
...
def _check_duplicate_labels(graph: Graph, namespace: Union[str, URIRef]):
    ...
    def in_namespace(item):
        ...
        #  `simphony_osp.core.ontology.namespace.OntologyNamespace.__contains__`,
        #  integrate somehow.
