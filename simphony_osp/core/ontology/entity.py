...
from simphony_osp.core.utils.datatypes import Triple, UID
...
if TYPE_CHECKING:
    ...
    from simphony_osp.core.wrapper import Wrapper
...
class OntologyEntity(ABC):
    ...
    def __init__(self,
        ...
        from simphony_osp.core.wrapper import Wrapper
        if session is None:
            from simphony_osp.core.ontology.interactive.container import \
                Container
            from simphony_osp.core.session import Environment, Session
