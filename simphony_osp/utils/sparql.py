...
class SparqlResultRow:
    ...
    def __init__(self, session: "Session", rdflib_row, datatypes=None):
...
class SparqlResult:
    ...
    def __init__(self, session: "Session", rdflib_result: Result):
        """Initialize the object."""
        self.session = session
    ...
    def __iter__(self):
        ...
        for x in self._rdflib_result:
            yield SparqlResultRow(session=self.session, rdflib_row=x)
    ...
    def __call__(self, **kwargs):
        ...
        for x in self._rdflib_result:
            yield SparqlResultRow(
                session=self.session, rdflib_row=x, datatypes=kwargs
            )
