...
class TestOntologyEntity(unittest.TestCase):
    ...
    def test_subclass(self):
        ...
        self.assertEqual(
            city.GeographicalPlace.subclasses,
            {
        ...
        self.assertEqual(
            city.GeographicalPlace.superclasses,
            {cuba.Entity, city.GeographicalPlace},
        )
        self.assertEqual(
            city.GeographicalPlace.direct_subclasses,
            {city.PopulatedPlace, city.ArchitecturalStructure},
        )
        self.assertEqual(
            city.GeographicalPlace.direct_superclasses, {cuba.Entity}
        )
        self.assertEqual(
            city.hasPart.subclasses,
            {city.hasPart, city.hasMajor, city.hasChild, city.hasWorker},
        )
        self.assertEqual(
            city.hasPart.superclasses,
            {
                city.encloses,
        ...
        self.assertEqual(
            city.hasPart.direct_subclasses, {city.hasChild, city.hasWorker}
        )
    ...
    def test_get_triples(self):
        ...
        self.assertEqual(
            set(city.coordinates.get_triples()),
            {
                (
    ...
    def test_directly_connected(self):
        ...
        self.assertEqual(
            set(
                city.PopulatedPlace._directly_connected(
                    rdflib.RDFS.subClassOf, inverse=True
                )
            ),
            {city.Street, city.City, city.Neighborhood},
    ...
    def test_oclass_attributes(self):
        ...
        self.assertEqual(
            city.GeographicalPlace.own_attributes,
            {
                city.name: (None, True, None),
            },
        )
        self.maxDiff = None
        self.assertEqual(
            city.LivingBeing.own_attributes,
            {
        ...
        self.assertEqual(
            city.PopulatedPlace.attributes,
            {
                city.name: (None, True, None),
                city.coordinates: (rdflib.Literal("[0, 0]"), False, None),
            },
        ...
        self.assertEqual(
            city.GeographicalPlace.attributes,
            {
                city.name: (None, True, None),
            },
        )
    ...
    def test_oclass_get_default(self):
        ...
        self.assertEqual(
            city.City._get_default(city.name.iri, city.City.iri), None
        )
        self.assertEqual(
            city.City._get_default(city.name.iri, city.GeographicalPlace.iri),
            None,
        )
        self.assertEqual(
            city.City._get_default(city.coordinates.iri, city.City.iri), None
        )
        self.assertEqual(
            city.City._get_default(
                city.coordinates.iri, city.PopulatedPlace.iri
            ),
    ...
    def test_get_attribute_values(self):
        ...
        self.assertRaises(
            TypeError,
            city.City._get_attributes_values,
            kwargs={},
            _force=False,
        )
        self.assertRaises(
        ...
        self.assertEqual(
            city.City._get_attributes_values(kwargs={}, _force=True),
        ...
        self.assertEqual(
            ...
            {city.name: "Freiburg", city.coordinates: [1, 1]},
        )
    ...
    def test_get_attribute_by_argname(self):
        ...
        self.assertEqual(
            city.City.get_attribute_by_argname("coordinates"), city.coordinates
        )
    ...
    def test_rel_inverse(self):
        ...
        self.assertEqual(
            cuba.activeRelationship.inverse, cuba.passiveRelationship
        )
        self.assertEqual(
            cuba.passiveRelationship.inverse, cuba.activeRelationship
        )
        self.assertEqual(city.hasMajor.inverse, city.INVERSE_OF_hasMajor)
        self.assertEqual(
            city.INVERSE_OF_hasMajor.direct_superclasses, {city.worksIn}
        )
    ...
    def test_attribute_datatype(self):
        ...
        self.assertEqual(
            city.coordinates.datatype, rdflib_cuba["_datatypes/VECTOR-INT-2"]
        )
        ...
        self.assertRaises(
            ValueError, city.coordinates.convert_to_datatype, "[1, 2]"
        )
        self.assertRaises(
            ValueError, city.coordinates.convert_to_datatype, [1, 2, 3]
        )
        self.assertTrue(
            np.all(
        ...
        self.assertEqual(
            city.coordinates.convert_to_basic_type(np.array([1, 2])), [1, 2]
        )
    ...
    def test_hasValue_statement(self):
        ...
        triples_hassymboldata = (
            (
                rdflib.URIRef("http://www.osp-core.com/city#" "hasSymbolData"),
                rdflib.RDF.type,
                rdflib.OWL.DatatypeProperty,
            ),
        )
        ...
        triples_restriction = (
            ...
            (
                bnode,
                rdflib.OWL.hasValue,
                rdflib.Literal("C", datatype=rdflib.XSD.string),
            ),
        )
        triples_carbonsymbol = (
            (
                rdflib.URIRef("http://www.osp-core.com/city#" "CarbonSymbol"),
                rdflib.RDF.type,
                rdflib.OWL.Class,
            ),
            (
