...
def benchmark_add_default(benchmark):
    ...
    return Cuds_add_Default.iterate_pytest_benchmark(
...
def benchmark_cuds_get_byuiduuid(benchmark):
    ...
    return Cuds_get_ByuidUUID.iterate_pytest_benchmark(
        benchmark, size=DEFAULT_SIZE
    )
...
def benchmark_get_byuiduriref(benchmark):
    ...
    return Cuds_get_ByuidURIRef.iterate_pytest_benchmark(
        benchmark, size=DEFAULT_SIZE
    )
...
def benchmark_get_byrel(benchmark):
    ...
    return Cuds_get_ByRel.iterate_pytest_benchmark(
        benchmark, size=DEFAULT_SIZE
    )
...
def benchmark_cuds_iter_byuiduuid(benchmark):
    ...
    return Cuds_iter_ByuidUUID.iterate_pytest_benchmark(
        benchmark, size=DEFAULT_SIZE
    )
...
def benchmark_cuds_iter_byuiduriref(benchmark):
    ...
    return Cuds_iter_ByuidURIRef.iterate_pytest_benchmark(
        benchmark, size=DEFAULT_SIZE
    )
...
def benchmark_cuds_iter_byrel(benchmark):
    ...
    return Cuds_iter_ByRel.iterate_pytest_benchmark(
        benchmark, size=DEFAULT_SIZE
    )
...
def benchmark_iter_byoclass(benchmark):
    ...
    return Cuds_iter_Byoclass.iterate_pytest_benchmark(
        benchmark, size=DEFAULT_SIZE
    )
...
def benchmark_cuds_attributes(benchmark):
    ...
    return Cuds_attributes.iterate_pytest_benchmark(
        benchmark, size=DEFAULT_SIZE
    )
