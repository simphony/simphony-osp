...
class Parser:
    ...
    def get_inherited_attributes(self, entity):
        ...
        """
        ancestors = self.get_set_ancestors(entity)
        attributes = set()
    ...
    def get_set_ancestors(self, leaf_entity):
        """
        Computes all the entities above a given one.
        
        :param leaf_entity: entity at the base
        :return: set(str) with the parent entity and its parent until the root
        """
        ancestors = set()
    ...
    def get_set_descendants(self, root_entity):
        """
        Computes all the entities under a given one.

        :param root_entity: entity at the top
        :return: set(str) with the child entity and its child until the leaf
        """
