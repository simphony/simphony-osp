...
ALL_KEYS = [IDENTIFIER_KEY, RDF_FILE_KEY, NAMESPACES_KEY, ACTIVE_REL_KEY,
            DEFAULT_REL_KEY, FILE_FORMAT_KEY, REQUIREMENTS_KEY,
            REFERENCE_STYLE_KEY, FILE_HANDLER_KEY]
