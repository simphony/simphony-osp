...
print(
    "- retrieve the 'Living Being' class by suffix:",
    city.LivingBeing
)
print(
    "- retrieve the 'Living Being' class by label:",
    city["Living Being"]
)
...
print(
    "- language of main label",
    city.City.label_lang
)
print(
    "- main label as an RDFLib literal",
    city.City.label_literal
)
print(
    "- all labels as RDFLib literal(s)",
...
print(
    "- superclasses:",
    city.LivingBeing.superclasses
)
print(
    "- subclasses:",
    city.LivingBeing.subclasses
)
print(
    "- direct superclasses :",
    city.LivingBeing.direct_superclasses
)
print(
    "- direct subclasses:",
    city.LivingBeing.direct_subclasses
)
...
print(
    ...
    city.LivingBeing.is_superclass_of(city.Person)
)
# - type of entity
...
print(
    ...
    and (not city.LivingBeing.is_subclass_of(owl.topObjectProperty)  # yet
         and not city.LivingBeing.is_subclass_of(owl.topDataProperty))  # other
)
print(
...
print(
    ...
    and city.hasInhabitant.is_subclass_of(owl.topObjectProperty)  # another way
)
print(
...
print(
    "- is an annotation?",
    isinstance(rdfs.label, OntologyAnnotation)
)
