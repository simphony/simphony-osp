...
from osp.core.tools import import_cuds, export_cuds, branch, pretty_print
...
c = branch(branch(city.City(name="Freiburg",
                  ...
                  city.Citizen(name="Pablo",
                               age=30,
                               iri='http://example.org/Pablo'),
                  city.Citizen(name="Yoav",
                               age=23,
                               iri='http://example.org/Yoav'),
                  rel=city.hasInhabitant),
           city.Neighborhood(name="Stühlinger", coordinates=[0, 0],
                             iri='http://example.org/Stühlinger'),
           city.Neighborhood(name="Herdern", coordinates=[0, 0],
                             iri='http://example.org/Stühlinger'))
